...
with open("samsclub_receipt.png", "rb") as f:
...
# Define regular expressions to match item details and date
...
for line in ocr_lines:
    ...
    if primary_match:
        ...
        if item_number.isdigit():  #number is numeric
